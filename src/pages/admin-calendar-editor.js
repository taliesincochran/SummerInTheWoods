...
class AdminCalendarEditor extends React.Component {
	...
	getDateFromInput = (inputDate) => {
		const dateArray = inputDate.split('-');
	    // const date = this.getDateOfDayNearDateX(dateArray[0], dateArray[1], dateArray[2], 1);
		return date;
	}
	componentDidMount() {
	        ...
	        <div>
	            ...
	            <div id="main">
		            ...
		            <form id="firstDayOfCamp">
		                <div className="inner">
			                <label for="firstMonth" />What is the first day of camp?
			                <input name="firstDay" type="date" onChange={this.handleChange} />
			                <label for="lastDay" />What is the last day of camp?
			                <input name="lastDay" type="date" onChange={this.handleChange} />
